...
export const AppGame: React.FC<AppGameProps> = ({
  question,
  selectedAnswer,
  onSelectAnswer,
  disabled = false,
    ...
    <div className="flex flex-col items-center w-full max-w-xl mx-auto">
      ...
      <div className="w-full bg-surface-container rounded-3xl p-6 sm:p-8 mb-6 border border-outline-variant shadow-xs">
        <div className="flex items-center gap-2 text-primary text-xs uppercase font-bold tracking-widest mb-3">
          <MaterialSymbols icon="help_outline" size={18} fill />
          <span>App Riddle</span>
        </div>
        <blockquote className="text-base sm:text-lg text-on-surface font-medium leading-relaxed italic">
          &ldquo;{question.clue}&rdquo;
        </blockquote>
      </div>
